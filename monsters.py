...
monsters = [
    ...
    Monster("Bandit Captain", "Bandit Captains", 2, True, "Human"),
    Monster("Berserker", "Berserkers", 2, True, "Human"),
    ...
    Monster("Cult Fanatic", "Cult Fanatics", 2, True, "Human"),
    Monster("Druid", "Druids", 2, True, "Human"),
